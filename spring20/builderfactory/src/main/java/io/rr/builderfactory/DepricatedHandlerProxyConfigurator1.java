...
public class DepricatedHandlerProxyConfigurator1 implements ProxyConfigurator {
    @Override
    public Object replaceWithProxyIfNeeded(Object t, Class implClass) {
        if (implClass.isAnnotationPresent(Deprecated1.class)) {
    ...
    private Object invocationHandlerLogic(Object t, Method method, Object[] args) throws IllegalAccessException, InvocationTargetException {
        System.out.println(t.getClass() + " 111111111111111 the class is deprecated");
